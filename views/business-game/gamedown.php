...
<script type="text/javascript">
	...
	function end() {
		...
		if (s1 == 1 && s2 == 1)
			...
			elem.innerHTML = 'Вы опустили сумму ниже средней по рынку, шанс убыточного контракта. К сожалению, такое иногда случается, Вам необходимо внимательнее изучать анализировать закупки для тендера. В качестве утешительного приза Вам начислены 10 IGC и 10 очков опыта'
